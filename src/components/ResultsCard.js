            ...
            <div className="relative aspect-[9/16] rounded-xl overflow-hidden bg-dark-950 border border-slate-800">
              <img
                ...
                onError={(e) => {
                  ...
                  e.target.src =
                    "https://placehold.co/600x800/2e3a52/ffffff?text=TikTok+Video";
                }}
              />
            ...
            <div className="flex items-center gap-4 pb-4 mb-6 border-b border-slate-800">
              <img
                ...
                onError={(e) => {
                  e.target.onerror = null;
                  e.target.src =
                    "https://placehold.co/100x100/2e3a52/ffffff?text=User";
                }}
              />
              <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {videoData?.video_url && (
                  <a
                    ...
                    className="flex items-center justify-center gap-2 px-4 py-3 rounded-lg bg-gradient-to-r from-[#FF0050] to-[#00F2EA] text-white font-semibold hover:shadow-lg hover:-translate-y-0.5 transition-all"
                  >
                ...
                {videoData?.audio_url && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center justify-center gap-2 px-4 py-3 rounded-lg bg-gradient-to-r from-[#1DB954] to-[#1ED760] text-white font-semibold hover:shadow-lg hover:-translate-y-0.5 transition-all"
                  >
